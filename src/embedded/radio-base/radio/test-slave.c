...
int main() {
	RadioMessage msg;
	uint8_t buf[] = {0x02, 0x01, 0xDA, 0xA3, 0x00, 0x69, 0xEB, 0x10, 0x42, 0xC4, 0x52, 0x5F, 0xBD, 0xA8, 0xDC, 0x3F, 0x74, 0x64};
